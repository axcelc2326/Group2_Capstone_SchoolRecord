        ...
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            >
              ...
              <div class="absolute inset-0 rounded-2xl bg-gradient-to-br from-orange-50/50 to-red-50/50 dark:from-orange-900/20 dark:to-red-900/20 pointer-events-none"></div>
                ...
                <div class="space-y-2">
                  ...
                  <div class="relative group">
                    ...
                    <input
                      ...
                      placeholder="Enter class name (e.g., Rose Section, Diamond Class)"
                    />
                  </div>
