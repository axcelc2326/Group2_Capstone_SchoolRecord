            ...
            >
              ...
              <form @submit.prevent="submit" class="relative space-y-6">
                ...
                <div class="text-center space-y-2">
                  ...
                  <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Announcement</h2>
                  <p class="text-sm text-gray-600 dark:text-gray-400">Share important information with parents</p>
                </div>

                <!-- Title Field -->
                <div class="space-y-2">
                  <label for="title" class="text-sm font-medium text-gray-700 dark:text-gray-300">Announcement Title</label>
                ...
                <!-- Body Field -->
                <div class="space-y-2">
                  <label for="body" class="text-sm font-medium text-gray-700 dark:text-gray-300">Message</label>
                  <div class="relative group">
