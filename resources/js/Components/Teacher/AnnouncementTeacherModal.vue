            ...
            >
              ...
              <form @submit.prevent="submit" class="relative space-y-6">
                ...
                <div class="text-center space-y-2">
                  ...
                  <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Post Class Announcement</h2>
                  <p class="text-sm text-gray-600 dark:text-gray-400">Share important information with your students</p>
                </div>
